...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        toolBar.arr = [NSArray arrayWithObjects:@"教室",@"研讨室",@"会议室", nil];
...
-(void)layoutSubviews
{
    ...
    self.dateButton.frame = CGRectMake(10, self.toolBar.maxY, self.width-2*10, 30);
}

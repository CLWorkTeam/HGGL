...
- (void)setupSubviews{
    ...
    UILabel *label1 = [[UILabel alloc]initWithFrame:CGRectMake(20, self.bar.maxY+40, 100, 100)];
    ...
    UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(20, label1.maxY+25, 100, 100)];
    ...
    nodataBtn.frame = CGRectMake(label2.maxX - 5, label2.y, 150, label2.height);
    ...
    UILabel *label3 = [[UILabel alloc]initWithFrame:CGRectMake(20, label2.maxY+25, 100, 100)];
    ...
    UILabel *label4 = [[UILabel alloc]initWithFrame:CGRectMake(20, label3.maxY+30, HGScreenWidth-40, 100)];
    ...
    UILabel *label5 = [[UILabel alloc]initWithFrame:CGRectMake(label4.maxX+5, label4.y, HGScreenWidth-label4.maxX-25, 100)];

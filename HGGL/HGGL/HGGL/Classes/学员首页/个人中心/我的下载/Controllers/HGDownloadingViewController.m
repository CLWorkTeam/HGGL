...
@interface HGDownloadingViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HGDownloadingViewController
...
-(void)getDataArray
{
    ...
    for (TKDownLoadModel *model in [TKDownLoadManager share].downloadingArray) {
...
-(void)clickBut:(UIButton *)button
{
    ...
    }else
    {
        ...
        [manager deleteTaskWith:deleteArray forStatus:NO];

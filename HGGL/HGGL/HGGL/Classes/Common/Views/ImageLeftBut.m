...
-(void)layoutSubviews
{
    ...
    self.imageView.center = CGPointMake(CellHMargin+W/2, self.frame.size.height/2);
    self.titleLabel.bounds = CGRectMake(0, 0, TW,TH);
    self.titleLabel.center = CGPointMake(2*CellHMargin+W+TW/2, self.frame.size.height/2);
